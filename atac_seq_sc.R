...
#Drosophila single chromosomes: "/nfs/genomes/d.melanogaster_aug_14/fasta_canonical/chr2R.fa"

#Read genome file path
genome <- "/nfs/genomes/d.melanogaster_aug_14/fasta_canonical/chr2R.fa"
...
#make an output path
outBAM <- "/lab/solexa_lehmann/Dros-ATAC-seq-analysis/ATAC_0.3.bam"
...
sortedBAM <- "/lab/solexa_lehmann/Dros-ATAC-seq-analysis/Sorted_ATAC_0.3.bam"
...
outBAM_postqc <- "/lab/solexa_lehmann/Dros-ATAC-seq-analysis/ATAC_0.3.bam"

#Set file path for the post quality control sorted file
sortedBAM_postqc <- "/lab/solexa_lehmann/Dros-ATAC-seq-analysis/Sorted_ATAC_0.3.bam"
...
#pdf(file="/lab/solexa_lehmann/Dros-ATAC-seq-analysis/dist_mapped_reads_0.3xTn5.pdf", width = 10, height = 10)
...
pdf(file="/lab/solexa_lehmann/Dros-ATAC-seq-analysis/fragment_lengths_chr2R_0.3xTn5.pdf", width = 5, height = 5)
fragLenPlot + theme_bw() + xlim(0,2000) + ylim(0,3000)
dev.off()

#Fragment length plot with y axis in log scale
pdf(file="/lab/solexa_lehmann/Dros-ATAC-seq-analysis/fragment_lengths_ylog_chr2R_0.3xTn5.pdf", width = 5, height = 5)
#plot on a log scale
